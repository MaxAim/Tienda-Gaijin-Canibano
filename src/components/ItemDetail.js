    ...
    <div>
      ...
      <div className={"subTable tableDetail"} style={{display: loaded !== 1 ? "none" : "flex", }}>
          ...
          <div style={{display: "grid", justifyItems: "center", width: "25%", padding: "2%"}}>
              <div style={{width: "100%", padding: "5%"}}><ItemCount stock={item.stock} num={num} setNum={setNum} /><div style={{width: "100%", paddingTop: "20%", fontSize: "2.3vw", display: item.stock === 0  ? "none" : "inline-flex"}}>¥{item.price}</div></div>
